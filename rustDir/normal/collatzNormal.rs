...
fn collatz_num_of_sequences(input: u64) -> u64 {
    let mut num_of_seq = 0;
...
fn collatz_num_of_sequences_print_top_ten(lower_limit: u64, upper_limit: u64) {
    ...
    for i in lower_limit..=upper_limit {
        let result = collatz_num_of_sequences(i);
...
fn main() {
    ...
    if lower_limit > 0 && upper_limit == 0 {
        let result = collatz_num_of_sequences(lower_limit);
